...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-02 12:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5c5469ed-516c-48bc-adab-c728de47505d.git
$ cd 5c5469ed-516c-48bc-adab-c728de47505d
```
